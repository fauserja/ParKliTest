...
#             fig = px.box(filtered_df, x='month', y=['fu_processed', 'fu_value'], points='all', title='Boxplot')
...
# # )
# # def update_graph(value, dataEyeonWater):
    
# #     df = pd.DataFrame(dataEyeonWater)
# #     if value == 'Box-Plot':
# #         fig = px.box(df, x='month', y=['fu_processed', 'fu_value'], points='all', title='Boxplot') 
        
# #         return fig
# #     elif value == 'Scatter-Plot':
        
# #         fig= px.scatter(df, x='month', y=['fu_processed', 'fu_value'], title='Scatter-Plot')
